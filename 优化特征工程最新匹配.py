...
# 输入输出设置
INPUT_FILE = "正负样本nuclear_receptor_BioAssay_data_canonical_aac_dpc_gnn_features.csv"  # 训练数据文件路径
OUTPUT_DIR = ("标准smiles特征核受体Combine_BioAssay增加gnn特征有监督降维")  # 输出目录，为空则自动生成以日期时间命名的目录
...
FINAL_DIMENSION = 2000  # 最终降维后的特征数量
